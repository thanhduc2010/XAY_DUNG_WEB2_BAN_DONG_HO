        ...
        <div class="vi-wpvs-attribute-content vi-wpvs-attribute-content-taxonomy">
            ...
            <div class="vi-wpvs-attribute-value-wrap-wrap" data-index="<?php echo esc_attr($i);?>"
                ...
                <p class="vi-wpvs-attribute-taxonomy-action">
                        <span class="vi-wpvs-attribute-taxonomy-select-all button button-small" data-total_term="<?php echo esc_attr(count($all_terms));?>">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="vi-attribute-image-wrap vi-attribute-edit-image-wrap vi-wpvs-term-image-upload-img">
                                                        <span class="vi-attribute-edit-image-preview vi-attribute-image-preview">
                                                            <img src="<?php echo esc_attr( esc_url( $attribute_img_src ) ); ?>" data-src_placeholder="<?php echo esc_attr(wc_placeholder_img_src('woocommerce_gallery_thumbnail')); ?>">
                                                        </span>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="vi-attribute-image-wrap vi-attribute-edit-image-wrap vi-wpvs-term-image-upload-img">
                                                        <span class="vi-attribute-edit-image-preview vi-attribute-image-preview">
                                                            <img src="<?php echo esc_attr( esc_url( wc_placeholder_img_src('woocommerce_gallery_thumbnail') ) ); ?>" data-src_placeholder="<?php echo esc_attr(wc_placeholder_img_src('woocommerce_gallery_thumbnail')); ?>">
                                                        </span>

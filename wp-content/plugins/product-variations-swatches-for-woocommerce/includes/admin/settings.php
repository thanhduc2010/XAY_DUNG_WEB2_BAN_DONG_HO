            ...
            <div class="vi-ui raised">
                <form action="" class="vi-ui form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="vi-ui vi-ui-main top tabular attached menu">
                        ...
                        <a class="item" data-tab="single_page"><?php esc_html_e( 'Swatches on Single page', 'product-variations-swatches-for-woocommerce' ); ?></a>
                    ...
                    <p class="vi-wpvs-save-wrap">
                        ...
                        <button type="button" class="vi-ui button negative labeled icon vi-wpvs-reset" name="vi-wpvs-reset">
                    ...
                    <div class="vi-ui vi-wpvs-import-wrap-wrap segment vi-wpvs-hidden">
                        <div class="vi-wpvs-import-wrap">
                            <input type="file" name="vi_wpvs_import_file" id="vi-wpvs-import-file" class="vi-wpvs-import-file" accept=".csv">
                            <button type="submit" class="vi-ui button green icon vi-wpvs-import1" name="vi-wpvs-import-choose_file">

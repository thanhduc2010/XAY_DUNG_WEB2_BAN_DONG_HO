...
class VI_WOO_PRODUCT_VARIATIONS_SWATCHES_Admin_Custom_Attribute {
	...
	function __construct() {
		...
		add_action( 'wp_ajax_vi_wvps_get_html_global_attrs_item', array( __CLASS__, 'vi_wvps_get_html_global_attrs_item' ) );
		add_action( 'wp_ajax_vi_wvps_get_html_global_attrs_items', array( __CLASS__, 'vi_wvps_get_html_global_attrs_items' ) );
	}
	...
	public function custom_attribute_product() {
		...
		$attribute_types       = wc_get_attribute_types();
		?>
        <div class="product_attributes vi-wpvs-attribute-wrap-wrap wc-metaboxes" data-product_id="<?php echo esc_attr($thepostid); ?>">
			<?php
        ...
        <div class="toolbar vi-wpvs-attribute-wrap-wrap">
			<span class="expand-close">
				<a href="#" class="expand_all"><?php esc_html_e( 'Expand', 'product-variations-swatches-for-woocommerce' ); ?></a> / <a
                        href="#"
                        class="close_all">
